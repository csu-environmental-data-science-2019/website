...
of time you enjoy working whether it be graduate school, post-doc, government
work, or really anything else. Further, it's a versatile skill that is transferable
...
will be an analysis that goes in your undergrad, masters, or PhD thesis. 
...
RMarkdown or as committed as only writing everything in R: emails, your personal 
website, shopping lists, etc... The idea here is immersion, into the language, 
ways of asking for help, the community, and more! I promise this immersive 
approach will help in the short and long run. This is primary a coding class
...
peer grading, and a large range in R fluency. We all get better if we work 
together! Some of the best R training available come from groups with explicit
inclusivity goals and I think that is what makes this language and community 
great. I encourage you to check out [RLadies](https://rladies.org/about-us/).
...
community, but it is also a good general principal to keep in mind: what work
...
(maybe 10 years) technique of asking the internet for help. This is a great idea!
...
and a more general guide to hlep in R is here:
...
next Friday, unless otherwise stated.
